...
###
###(The original version of the file belongs to TURBO. See LICENSE_TURBO  for more information.)
###
###############################################################################
...
class TurboM(Turbo1):
    ...
    def optimize(self):
        ...
        self.time_per_step.append(after_init_time - before_init_time)
        self.evals_per_step.append(self.n_evals)
        ...
        while self.n_evals < self.max_evals:
            ...
            for i in range(self.n_trust_regions):
                if (
                    ...
                    self.n_evals += self.n_init
            end_time = time.time()
            self.time_per_step.append(end_time - start_time)
            self.evals_per_step.append(self.n_evals)
